...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # إضافة Whitenoise Middleware هنا
...
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage' # إضافة ده في الآخر
